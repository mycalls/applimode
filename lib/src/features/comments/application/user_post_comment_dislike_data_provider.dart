...
@riverpod
class UserPostCommentDislikeData extends _$UserPostCommentDislikeData {
  @override
  FutureOr<List<PostCommentLike>> build({
    ...
    dev.log(
        'UserPostCommentDislikeData (commentId: $commentId, uid: $uid): Build started.');
  ...
  void increaseOptimisticDislike({
    ...
    if (state.value != null && state.value!.isEmpty) {
      dev.log(
          'UserPostCommentDislikeData (commentId: $commentId, uid: $uid): increase Optimistic Dislike');
      state = AsyncData([
        PostCommentLike(
          id: id,
          uid: uid,
  ...
  void decreaseOptimisticDislike() {
    if (state.value != null && state.value!.isNotEmpty) {
      dev.log(
          'UserPostCommentDislikeData (commentId: $commentId, uid: $uid): decrease Optimistic Dislike');
      state = AsyncData([]);
    }
  }
  ...
  Future<void> refresh() async {
    dev.log(
        'UserPostCommentDislikeData (commentId: $commentId, uid: $uid): Manual refresh triggered.');
    ref.invalidateSelf();
